...
cd $CURRENT_DIR/$DIR
#xwalk修复
sed -i 's/download.01.org\/crosswalk\/releases\/crosswalk\/android\/maven2/raw.githubusercontent.com\/sturiss\/TVBoxOS/tree/0907unpdateConfirm\/main/g' $CURRENT_DIR/$DIR/build.gradle
#名称修改
sed -i 's/TVBox/追剧神器/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#背景修改
